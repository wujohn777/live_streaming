const FormAutoFill = new Vue({
  ...
  methods: {
    ...
    verify() {
      ...
      // var view_date = (this.view_date  == undefined) ? "" : this.view_date.trim();
      ...
      for (let i = 0; i < this.view.length; i++) {
        ...
        // alert(this.view[i].format("YYYY-MM-DD"));
        // alert(this.view[i].format("dddd"));
    ...
    submit() {
      ...
      if (this.verify()) {
        ...
        for (let i = 0; i < this.view.length; i++) {
          ...
          fetch(this.formSendAction + '?' + params, {
            method: 'POST'
          })
          .catch(err => {
          });
        ...
        fetch(this.formAction + '?' + params, {
           ...
           // this.loading = false;
           alert('登記成功，請複製登記網址傳給當事人訂閱，若已登記過就不需再登記了！');
           this.id = '';
           this.password = '';
